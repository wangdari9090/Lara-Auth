                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="sms-create-group @error('name') border-danger @enderror">
                            ...
                            <input type="text" name="name" class="create-form-input" placeholder="e.g. Advanced Web Development" value="{{ old('name') }}" required>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="sms-create-group @error('course_title') border-danger @enderror">
                            <i class="bi bi-book"></i>
                            <input type="text" name="course_title" class="create-form-input" placeholder="e.g. Advanced Web Development" value="{{ old('course_title') }}" required>
                        </div>
